...
from .cmake import check_cmake_dependencies_helper
    ...
    for rel_fn, plugin_info in defined_macros.items():
        ...
        for pkg1, name1, pkg2, name2 in plugin_info:
            ...
            if pkg2 not in existing_plugins:
                ...
                p_xml = PluginXML(xml_filename, os.path.join(package.root, xml_filename), package.ros_version == 1)
            ...
            for plugin_xml in existing_plugins[pkg2]:
                if package.ros_version == 1:
                    ...
                    package.cmake.section_check([pkg2, plugin_xml.rel_fn],
        ...
        if package.ros_version > 1:
            ...
            package.cmake.section_check([exported_library], 'ament_export_targets')
            ...
            check_cmake_dependencies_helper(package, {'ament_cmake_ros'})
